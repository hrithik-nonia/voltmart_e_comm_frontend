    ...
    <header>
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        ...
        <div className="flex flex-wrap items-center gap-3 shrink-0">
          {/* Date Range Dropdown/reset setting btn */}
          {location.pathname === "/adminSettingPage" ? (
            <>
              <button
                type="button"
          ...
          {location.pathname === "/adminSettingPage" ? (
            <>
              <button
                type="button"
                className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700/80 border border-slate-800 text-xs sm:text-sm font-semibold text-slate-200 transition-colors cursor-pointer"
              >
